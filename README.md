...
``` typescript
import pkg from 'https://unpkg.com/oneday@^4.5.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/oneday/^4.5.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/oneday@^4.5.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/oneday@4.5.0'
</script>
```
