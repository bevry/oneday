...
``` typescript
import pkg from 'https://unpkg.com/oneday@^5.3.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/oneday@^5.3.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/oneday@^5.3.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/oneday@5.3.0'
</script>
```
